...
func get_tile_coords(mouse_global_pos) -> Vector2i :
	return get_mouse_tile_coords(find_tile_map_layer_index(mouse_global_pos), mouse_global_pos)
func get_tile_coords_ground(mouse_global_pos) -> Vector2i :
	return get_mouse_tile_coords(find_tile_map_layer_index_ground(mouse_global_pos), mouse_global_pos)
